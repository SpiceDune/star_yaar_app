  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-xs px-3.5 py-2 transition-colors cursor-pointer"
      >
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setShowModal(false)}>
          <div className="bg-white rounded-2xl shadow-2xl w-[420px] max-w-[92vw] overflow-hidden" onClick={e => e.stopPropagation()}>
            <div className="bg-primary px-5 py-3.5 flex items-center justify-between rounded-t-2xl">
              <span className="text-primary-foreground text-sm font-semibold">Share Birth Chart</span>
              <button onClick={() => setShowModal(false)} className="text-primary-foreground/50 hover:text-primary-foreground transition-colors">
